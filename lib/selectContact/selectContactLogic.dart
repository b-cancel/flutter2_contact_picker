...
import 'package:flutter2_contact_picker/newContact/categorySelect.dart';
import 'package:permission_handler/permission_handler.dart';

import '../request.dart';
import 'selectContactUX.dart';
...
class _SelectContactState extends State<SelectContact>
  ...
  ValueNotifier<List<Contact>> contacts =
      ValueNotifier<List<Contact>>(new List<Contact>());
  ...
  void initState() {
    ...
    if (firstPage) {
      //we are selecting one for the first time
      ...
      //we may or may not be updating or selecting it for the first time
      onSelect = (BuildContext context, Contact contact) {
  ...
  ValueNotifier<bool> backFromPageNOTpermissionPage =
