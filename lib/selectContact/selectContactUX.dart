...
import 'package:flutter2_contact_picker/newContact/newContact.dart';
...
class _SelectContactUXState extends State<SelectContactUX> {
  ...
  final ValueNotifier<List<int>> sortedLetterCodes =
      new ValueNotifier(new List<int>());
  final ValueNotifier<Map<int, List<Widget>>> letterToListItems =
      new ValueNotifier(new Map<int, List<Widget>>());
  final ValueNotifier<Map<String, List<Widget>>> nameToTiles =
      new ValueNotifier(new Map<String, List<Widget>>());
            ...
            children: <Widget>[
              AnimatedBuilder(
                ...
                builder: (context, child) {
                  ...
                  expandedBannerHeight = (expandedBannerHeight < (16 + 24))
                      ? 40
                      : expandedBannerHeight;
                  ...
                  if (isPortrait) {
                    ...
                    for (int i = 0; i < widget.userPrompt.length; i++) {
                      if (i == 0)
                        generateString += widget.userPrompt[i];
                      else
                        generateString += (" " + widget.userPrompt[i]);
                    }
                  ...
                  List<Widget> headerSlivers = [
                    ...
                    ToolBar(
                      ...
                      orientationPrompt:
                          orientationPrompt, //varies with orientation
                      backFromPageNOTpermissionPage:
                          widget.backFromPageNOTpermissionPage,
                          ...
                          child: Hero(
                            flightShuttleBuilder: (
                              ...
                              if (flightDirection == HeroFlightDirection.pop) {
                                ...
                                theHero = fromHeroContext.widget;
